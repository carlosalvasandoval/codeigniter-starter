...
$url_complete = str_replace(basename($_SERVER['SCRIPT_NAME']), '', $_SERVER['SCRIPT_NAME']);
$pos = strpos($url_complete, 'responsive_filemanager');
$path = substr($url_complete, 0, $pos);
define('FCPATH', $path);
//
...
$config = array(
  ...
  /*
    ...
    |
   */
  'upload_dir'   => FCPATH . 'assets/img/source/',
  /*
    |--------------------------------------------------------------------------
    ...
    |
   */
  'current_path' => '../../assets/img/source/',
  /*
    |--------------------------------------------------------------------------
